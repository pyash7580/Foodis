    ...
    def _safe_restaurant_data(self, restaurant, request):
        ...
        try:
            ...
            return {
                ...
                'slug': getattr(restaurant, 'slug', ''),
                'status': getattr(restaurant, 'status', ''),
                'city': getattr(restaurant, 'city', ''),
                'state': getattr(restaurant, 'state', ''),
                'pincode': getattr(restaurant, 'pincode', ''),
                'email': getattr(restaurant, 'email', ''),
                'address': getattr(restaurant, 'address', ''),
                'delivery_time': getattr(restaurant, 'delivery_time', 0),
                'delivery_fee': getattr(restaurant, 'delivery_fee', 0),
                'min_order_amount': getattr(restaurant, 'min_order_amount', 0),
                'is_active': getattr(restaurant, 'is_active', False),
                'rating': getattr(restaurant, 'rating', 0),
                'total_ratings': getattr(restaurant, 'total_ratings', 0),
                'profile': None,
            }
