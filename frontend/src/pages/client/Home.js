        ...
        <div className="min-h-screen bg-white">
            ...
            <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="flex items-center justify-between mb-8">
                    ...
                    {searchMode === 'restaurant' && (
                        <div className="flex gap-2 w-full md:w-auto overflow-x-auto pb-2 no-scrollbar scroll-x-snap">
                            <button
                                onClick={() => setSortBy('rating')}
                                className={`px-4 py-2 rounded-xl text-sm font-bold min-w-max whitespace-nowrap transition-all ${sortBy === 'rating' ? 'bg-red-50 text-red-600 border border-red-200' : 'bg-gray-50 text-gray-600 border border-transparent hover:bg-gray-100'} no-tap-fix`}
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-xl text-sm font-bold min-w-max whitespace-nowrap transition-all ${sortBy === 'cost_low' ? 'bg-red-50 text-red-600 border border-red-200' : 'bg-gray-50 text-gray-600 border border-transparent hover:bg-gray-100'} no-tap-fix`}
                                style={{ minHeight: 'unset' }}
                            >
                                Price: Low to High
                            </button>
                            <button
                                onClick={() => setSortBy('cost_high')}
                                className={`px-4 py-2 rounded-xl text-sm font-bold min-w-max whitespace-nowrap transition-all ${sortBy === 'cost_high' ? 'bg-red-50 text-red-600 border border-red-200' : 'bg-gray-50 text-gray-600 border border-transparent hover:bg-gray-100'} no-tap-fix`}
                                style={{ minHeight: 'unset' }}
                            >
                                Price: High to Low
                            </button>
